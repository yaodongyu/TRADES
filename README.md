...
### What is TRADES?
TRADES is a loss function for adversarial training with theoretical guarantees.
<script type="text/javascript" src="http://cdn.mathjax.org/mathjax/latest/MathJax.js?config=default"></script>$$\frac{1}{4}$$
